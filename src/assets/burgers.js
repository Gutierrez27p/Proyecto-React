    ...
    [
        {
            id: "111",
            name: "Lenny Beyond",
            description: "Medallón Beyond Meat 100% a base de plantas sin soja, cheddar, lechuga, tomate y salsa Lenny's.",
            size: " SIMPLE ",
        ...
        },
        {
            id: "112",
            name: "Lenny Burger",
            description: "Hamburguesa de carne 120g, cheddar, lechuga, tomate y salsa Lennys.",
            size: " DOBLE | SIMPLE ",
        ...
        },
        {
            id: "113",
            name: "Cheese Burger",
            description: "Hamburguesa de carne 120g, cheddar, y salsa Lennys o Magic Carl.",
            size: " DOBLE | SIMPLE ",
        ...
        },
        {
            id: "114",
            name: "Bacon Cheese",
            description: "Hamburguesa de carne 120g, cheddar, panceta crocante y salsa Lennys.",
            size: " DOBLE | SIMPLE ",
        ...
        },
        {
            id: "115",
            name: "Carl Bacon",
            description: "Hamburguesa de carne 120g, cheddar, panceta crocante, barbacoa, cebolla morada y salsa lennys.",
            size: " DOBLE | SIMPLE ",
        ...
        {
            id: "116",
            name: "Lenny veggie Burger",
            description: "Medallón de portobellos con muzarella, lechuga, tomate y salsa Lennys.",
            size: " DOBLE | SIMPLE ",
        ...
        },
        {
            id: "117",
            name: "Sweet Carl",
            description: "Hamburguesa de carne 120g, cheddar, cebolla caramelizada, tomate y salsa Lennys.",
            size: " DOBLE | SIMPLE ",
        ...
        },
        {
            id: "118",
            name: "Chicken Lenny",
            description: "Medallón de pollo, cheddar, lechuga, tomate y salsa Lennys.",
            size: " DOBLE | SIMPLE ",
        ...
        },
        {
            id: "119",
            name: "Super Carl",
            description: "Hamburguesa de carne 120g, cheddar, lechuga, pepinillos, cebolla y salsa Lennys.",
            size: " DOBLE | SIMPLE ",
        ...
        {
            id: "120",
            name: "Cheese Burger Urban 80g",
            description: "Hamburguesa de carne 80g, cheddar, y salsa Lennys o Magic Carl.",
            size: " DOBLE | SIMPLE ",
        ...
        {
            id: "121",
            name: "Lenny Burger Urban 80g",
            description: "Hamburguesa de carne 80g, cheddar, tomate, lechuga y salsa Lennys.",
            size: " DOBLE | SIMPLE ",
        ...
        {
            id: "122",
            name: "Bacon Cheese Urban 80g",
            description: "Hamburguesa de carne 80g, cheddar, panceta y salsa Lennys.",
            size: " DOBLE | SIMPLE ",
